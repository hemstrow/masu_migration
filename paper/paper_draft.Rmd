...
```{r Figure_2_print,echo=FALSE,warning=FALSE,include=TRUE,fig.cap="Figure 2: PCA plot showing the relatedness between anadromous and resident individuals in TK and CH populations",fig.width=7, fig.height=4, fig.align='center', fig.cap.style="Image Caption"}
p1 
