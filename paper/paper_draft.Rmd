...
We then used NGSadmix (not sure how to describe this). With our data, we also made a Principle Component Analysis chart (PCA) using the ANGSD-IBS method [@Korneliussen2014]. In the PCA, we included the centroids of each cluster. The centroid of each cluster is the mean of that cluster of points. 
